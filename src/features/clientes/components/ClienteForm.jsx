...
export function ClienteForm({ editing, clienteForm, setClienteForm, submitCliente, resetCliente, saving }) {
  return (
    <FormPanel
    ...
    >
      ...
      <label>Identificacion<input value={clienteForm.identificacion} onChange={(event) => setClienteForm({ ...clienteForm, identificacion: event.target.value })} /></label>
